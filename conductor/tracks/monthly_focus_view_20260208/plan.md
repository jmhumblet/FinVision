...
- [ ] Task: Write failing tests for `MonthlySetupModal` component.
- [ ] Task: Implement `MonthlySetupModal` with balance input and transaction checklist.
- [ ] Task: Add "Set as Default View" preference toggle to the modal.
- [ ] Task: Implement logic to mark projected transactions as "occurred" based on setup selection.
- [ ] Task: Conductor - User Manual Verification 'Phase 2: Initial Setup UI' (Protocol in workflow.md)
