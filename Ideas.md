...
**Status:** Unimplemented
**Description:**
A specialized module comparing Snowball vs. Avalanche payoff strategies with interactive visualization and integration into the core cash flow projections.
**User Story:**
As a user with multiple debts, I want to compare different payoff strategies (Snowball vs. Avalanche) so that I can minimize interest paid and visualize my path to becoming debt-free.
**Acceptance Criteria:**
- Users can input multiple debts with balances, interest rates, and minimum payments.
- The system automatically calculates and displays the payoff timeline and total interest for both Snowball (lowest balance first) and Avalanche (highest interest rate first) strategies.
- Visual charts show the debt decreasing over time under each strategy.
- Users can input an "extra monthly payment" amount and instantly see how it accelerates the payoff.
- The chosen payoff plan can be integrated into the main `projections` list to reflect the monthly cash flow commitment.
