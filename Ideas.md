...
**Description:**
A feature allowing users to upload or scan receipts. AI automatically extracts transaction details (amount, date, merchant, categories) and creates a record.
